...
///
//--------------------------------------------------------------------------------------------------
RimEnsembleParameterColorHandlerInterface::ColorMode RimWellRftEnsembleCurveSet::colorMode() const
{
...
{
    auto ensembleParam = m_ensemble->ensembleParameter( m_ensembleParameter );
    return RimEnsembleParameterColorHandlerInterface::caseColor( m_ensembleLegendConfig, summaryCase, ensembleParam );
}
